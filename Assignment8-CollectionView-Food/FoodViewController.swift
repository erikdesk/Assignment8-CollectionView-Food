...
let filterItems = ["Mexican", "Korean", "Italian", "Japanese", "Chinese", "Mediterranean", "Greek", "Indian", "American", "Vegetarian"]
let restaurants = [
    Restaurant(name: "Chancho Tortilleria", filter: "Mexican", price: "🤑"),
    Restaurant(name: "Antojitos Cantina", filter: "Mexican", price: "🤑🤑🤑"),
    Restaurant(name: "Haru Korean Kitchen", filter: "Korean", price: "🤑🤑"),
    Restaurant(name: "Jang Mo Jib", filter: "Korean", price: "🤑"),
    Restaurant(name: "Basil Pasta Bar", filter: "Italian", price: "🤑🤑🤑"),
    Restaurant(name: "Italian Kitchen", filter: "Italian", price: "🤑"),
    Restaurant(name: "Yamato Sushi", filter: "Japanese", price: "🤑🤑🤑"),
    Restaurant(name: "Umeda", filter: "Japanese", price: "🤑🤑"),
    Restaurant(name: "Kings Kitchen 京東", filter: "Chinese", price: "🤑"),
    Restaurant(name: "Happy Noodle House", filter: "Chinese", price: "🤑🤑"),
    ...
    Restaurant(name: "BeetBox Veg", filter: "Vegetarian", price: "🤑🤑"),
    Restaurant(name: "Đồ Chay Saigon", filter: "Vegetarian", price: "🤑")
]
var selectedFilterItems = [false, false, false, false, false, false, false, false, false, false]
